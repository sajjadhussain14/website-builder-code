...
<div ${dropModeOff} class="col-lg-6 col-md-6 col-sm-12 col-12 text-center py-2">
    <a  ${editModeOff}  href="/">
        <img ${editModeOff} src="http://celerantcms-com.server-icumulusdataserver9-vps.vps.ezhostingserver.com/testsite/server/uploads/static/build-header-logo.png" class="f-header2-logo img-fluid w-100" alt="MainLogo">
    </a>
</div>
